...
const Composer: FC = () => {
  return (
    <ComposerPrimitive.Root className="flex w-full flex-wrap items-end rounded-lg border bg-green-500 bg-inherit px-2.5 shadow-sm transition-colors ease-in focus-within:border-ring/20">
